                ...
                <form role="form" accept="{{ url('produk/add') }}" method="post">
                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="number" name="buy" class="form-control" id="exampleInputEmail1" placeholder="Harga Produk">
                    </div>

                    <div class="form-group">
                      <label for="exampleInputEmail1">Harga Jual  Produk</label>
                      <input type="number" name="harga" class="form-control" id="exampleInputEmail1" placeholder="Harga Produk">
                    </div>
