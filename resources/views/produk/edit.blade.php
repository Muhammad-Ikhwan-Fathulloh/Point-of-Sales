                ...
                <form role="form" accept="{{ url('produk/'.$dt->id) }}" method="post">
                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="nama" class="form-control" id="exampleInputEmail1" placeholder="Nama Produk" value="{{ $dt->nama }}">
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="number" name="minimal_stock" class="form-control" id="exampleInputEmail1" placeholder="Minimal Stock" value="{{ $dt->minimal_stock }}">
                    </div>

                    <div class="form-group">
                      <label for="exampleInputEmail1">Harga Beli Produk</label>
                      <input type="number" name="buy" class="form-control" id="exampleInputEmail1" placeholder="Harga Produk" value="{{ $dt->buy }}">
                    </div>

                    <div class="form-group">
                      <label for="exampleInputEmail1">Harga Jual Produk</label>
                      <input type="number" name="harga" class="form-control" id="exampleInputEmail1" placeholder="Harga Produk" value="{{ $dt->harga }}">
                    </div>
